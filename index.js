...
function MenuElemaniOlustur(itemİsim, itemFiyat, itemKategori) {
  return { isim: itemİsim, fiyat: itemFiyat, kategori: itemKategori };
}
...
*/
console.log(MenuElemaniOlustur("Avokado Pizza", 8, "Pizza"));
console.log(MenuElemaniOlustur("Armut", 8, "Meyve"));
console.log(MenuElemaniOlustur("Kaşarlı Döner", 8, "Döner"));
...
function DegerlendirmeEkle(array, isim, puan, geribildirim) {
  const yeniEleman = { isim, puan, geribildirim };
  array.push(yeniEleman);
  return array;
}
